...
import sys, os
from oyreoloh.crawler import Crawler
from oyreoloh.attacks import *
from oyreoloh.utils import get_url_host, validate_url, dict_iterate, read_config, check_boolean_option
from oyreoloh.client import Client, NotAPage, RedirectedToExternal
from oyreoloh.app_detect import app_detect
from oyreoloh.logger import Log
...
ASCII_ART = r"""
  ____   __     __  _____  ______    ____  _         _     
 / __ \  \ \   / / |  __ \|  ____|  / __ \| |       | |    
| |  | |  \ \_/ /  | |__) | |__    | |  | | |  ___  | |__  
| |  | |   \   /   |  _  /|  __|   | |  | | | / _ \ | '_ \ 
| |__| |    | |    | | \ \| |____  | |__| | |  (_)  | | | |
 \____/     |_|    |_|  \_\______|  \____/|_| \___/ |_| |_|
                                                                                                                                                                                        
"""
DESC = r"""
Unleash Your Inner Cyber Guardian
Uncover hidden vulnerabilities in your digital fortress with our Python-powered assessment tool.
Before embarking on your security adventure, always secure explicit permission from the website owner.
Ethical hacking saves the day when done responsibly!
